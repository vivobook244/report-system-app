    ...
    return (
        <>
            ...
            <hr></hr>
            {
                ...
                } className="my-2" variant="outline-info"> Download File</Button> : null
            }
            {/* <p className="mt-2" >
            </p>
        */}
...
${props.comment}
                        ...
                        <Button className="mx-2" variant="danger" onClick={() => setShow(false)}>
                            Close
                        </Button>
                        <Button id="submit" variant="primary" onClick={
                            () => {
                                sendReport(props.to)
                            }
                        } >
